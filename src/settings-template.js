...
<div class="k-set-wrap">
  <div class="k-set-nav">
    ...
    <div class="k-set-navgrp"><span class="k-set-navgrp-ic" data-icon="globe" data-icon-size="14"></span> ${tx('ui.setTpl.levelUser')} <span class="k-set-navgrp-sub">${tx('ui.setTpl.useAllResultTask')}</span></div>
    ...
    <div class="k-set-navgrp"><span class="k-set-navgrp-ic" data-icon="folder" data-icon-size="14"></span> ${tx('ui.setTpl.onlyResultTask')} <span class="k-set-navgrp-sub">${tx('ui.setTpl.keepProjectKhnJson')}</span></div>
  ...
  <div class="k-set-main">
    ...
    <div class="k-set-page k-set-2col on" data-p="gen">
      ...
      <div class="k-set-sub k-full">${tx('ui.setTpl.actOpenProject')}</div>
      <div class="k-row"><label>${tx('ui.setTpl.showPageFirstOpen')}<span class="k-hint">${tx('ui.setTpl.closeOpenProjectLatest')}</span></label><input type="checkbox" id="st-showhome"></div>
    ...
    <div class="k-set-page" data-p="auto">
      ...
      <div class="k-set-sub k-full">${tx('ui.setTpl.adjustPageNewAuto')}</div>
    ...
    <div class="k-set-page k-set-2col" data-p="page">
      <div class="k-hint" style="margin-bottom:10px">${tx('ui.setTpl.sizePaperGapMargin')}</div>
      ...
      <div class="k-set-sub">${tx('ui.setTpl.ruleCutPageWidow')}</div>
      <div class="k-set-grid2">
      ...
      <div class="k-set-sub">${tx('ui.setTpl.textDefault')}</div>
    ...
    <div class="k-set-page k-set-2col" data-p="prose">
      ...
      <div class="k-row"><label>${tx('ui.setTpl.sizePt')}</label><input type="number" id="st-pr-pt" class="k-narrow" min="6" max="48" step="0.5"></div>
      ...
      <div class="k-row"><label>${tx('ui.setTpl.showPageNum')}</label><input type="checkbox" id="st-pr-pgnum"></div>
