...
export const TH_SYNONYMS = {
  'สวย': [T`งาม`, T`งดงาม`, T`เลอโฉม`, T`ตระการตา`],
  'เดิน': [T`ก้าว`, T`ย่าง`, T`ดำเนิน`, T`ย่างเท้า`],
  'พูด': [T`กล่าว`, T`เอ่ย`, T`บอก`, T`เปรย`, T`ปริปาก`],
  'มอง': [T`จ้อง`, T`เพ่ง`, T`ชายตา`, T`ทอดสายตา`],
  'กลัว': [T`หวาดกลัว`, T`ขยาด`, T`พรั่นพรึง`, T`ครั่นคร้าม`],
  'โกรธ': [T`เดือดดาล`, T`ขุ่นเคือง`, T`ฉุนเฉียว`, T`เกรี้ยวกราด`],
  'เศร้า': [T`โศก`, T`หม่นหมอง`, T`ระทม`, T`เสียใจ`],
  'ดีใจ': [T`ยินดี`, T`ปลาบปลื้ม`, T`ปีติ`, T`เบิกบาน`],
  'เร็ว': [T`ไว`, T`ฉับไว`, T`รวดเร็ว`, T`พลัน`],
  'ใหญ่': [T`มหึมา`, T`มโหฬาร`, T`โต`, T`กว้างขวาง`],
  'เล็ก': [T`จิ๋ว`, T`กระจิริด`, T`น้อย`, T`เล็กจ้อย`],
  'มืด': [T`มืดมิด`, T`สลัว`, T`อับแสง`, T`ทมิฬ`],
  'เงียบ': [T`สงบ`, T`เงียบสงัด`, T`ปราศจากเสียง`, T`สงัด`],
  'ตาย': [T`สิ้นใจ`, T`ดับสูญ`, T`ล่วงลับ`, T`วายชนม์`],
  'บ้าน': [T`เรือน`, T`ที่พัก`, T`ที่อยู่อาศัย`, T`คฤหาสน์`],
};
export const TH_ANTONYMS = {
  'สวย': [T`ขี้เหร่`, T`อัปลักษณ์`], 'ใหญ่': [T`เล็ก`, T`จิ๋ว`], 'เล็ก': [T`ใหญ่`, T`มหึมา`],
  'มืด': [T`สว่าง`, T`กระจ่าง`], 'เงียบ': [T`ดัง`, T`อึกทึก`], 'เร็ว': [T`ช้า`, T`เชื่องช้า`],
  'ดีใจ': [T`เศร้า`, T`เสียใจ`], 'เศร้า': [T`ดีใจ`, T`ยินดี`], 'กลัว': [T`กล้า`, T`ห้าวหาญ`],
};
