...
export class PlannerRenderer {
  ...
  _recordChildren(n, W, H, textFill, fs) {
    ...
    kids.push(new fabric.Textbox(_clip((ICONS[n.type] || '📄') + ' ' + (n.title || 'ไม่ระบุชื่อ'), 70), {
  ...
  _stickyChildren(n, W, H, textFill, fs) {
    ...
    return [
      ...
      new fabric.Textbox(body || 'ดับเบิลคลิกเพื่อเขียน', {
  ...
  _textChildren(n, W, H, textFill, fs) {
    return [
      ...
      new fabric.Textbox(n.title || 'ข้อความ', {
  ...
  _frameChildren(n, W, H, textFill, fs) {
    ...
    return [
      ...
      new fabric.Text(_clip('🖼 ' + (n.title || 'เฟรม'), 34), {
  ...
  _commentChildren(n, W, H, textFill, fs) {
    ...
    return [
      ...
      new fabric.Text('💬 ' + _clip(n.title || 'คอมเมนต์', 20), {
