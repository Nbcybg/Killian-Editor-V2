 ...
 */
// [alpha.164 · งาน 6] 260 → 420: หน้าต่าง 1440 + ต้นไม้ 277 + แชท AI 596 + คุณสมบัติ 279 เคยเหลือพื้นที่เขียน
// 260px จนข้อความหลุดขอบซ้าย · ตอนนี้แผงข้างเป็นฝ่ายหด (CSS `.k-flex-child{min-width}` ใช้ค่าเดียวกัน)
export const MIN_CANVAS_PX = 420;
