...
//
// ⚠️ [alpha.124 ข้อ 22] **สถานะ: ยังไม่ได้ต่อเข้า UI ใด ๆ**
// ไม่มีไฟล์ไหนใน src/ import โมดูลนี้เลย — แผงแชท AI ที่ผู้ใช้เห็นจริงคือ `ai/ai-chat-panel.js`
// ซึ่งเขียนสายของตัวเองแยกต่างหาก · ที่เก็บไฟล์นี้ไว้ (ไม่ลบทิ้ง) เพราะ:
//   · มี unit test คุมอยู่จริง (`test/ai-features.test.cjs`) — กฎ "ห้ามลด check"
//   · มีสเปกของตัวเอง (`docs/79-ai-chat.md`) และเป็นสาย RAG ที่ตั้งใจจะใช้ต่อ
// **ห้ามเพิ่มฟีเจอร์ที่นี่โดยคิดว่าผู้ใช้จะเห็น** — ต้องต่อเข้า ai-chat-panel.js ก่อนเท่านั้น
